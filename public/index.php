...
if (preg_match('/^\/news\/([^\/]+)\/?$/', $requestPath, $matches)) {
    ...
    $apiUrl = "https://api.dainiksabsetej.com/api/news/article/" . urlencode($slug);
    ...
    if ($response) {
        ...
        if ($article && !isset($article['message'])) {
            ...
            $rawTitle = trim(preg_replace('/\s+/', ' ', $article['title'] ?? 'दैनिक सबसे तेज़ News'));
            ...
            $rawImage = trim($article['image'] ?? 'https://dainiksabsetej.com/favicon.png');
...
";
            ...
            $html = preg_replace('/<title>.*?<\/title>/i', "<title>$title | दैनिक सबसे तेज़ News</title>", $html);
            ...
            $authorName = isset($article['author']) ? $article['author'] : 'दैनिक सबसे तेज़ News';
            ...
            $schemaJson = [
                ...
                "publisher" => [
                    "@type" => "Organization",
                    "name" => "दैनिक सबसे तेज़ News",
                    "logo" => [
                        "@type" => "ImageObject",
                        "url" => "https://dainiksabsetej.com/favicon.png"
                    ]
                ],
    ...
    $title = "ब्रेकिंग न्यूज़ | दैनिक सबसे तेज़";
