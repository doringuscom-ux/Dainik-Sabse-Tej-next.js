...
const AboutUs = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = 'About Us | दैनिक सबसे तेज़';
    }, []);
    ...
    return (
        <div className="w-full max-w-[1270px] mx-auto px-4 py-10">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
                <p className="text-lg font-semibold text-gray-800">Welcome to दैनिक सबसे तेज़ – दैनिक सबसे तेज़</p>
                <p>दैनिक सबसे तेज़ is your most trusted, fastest, and most comprehensive source for news and updates. Founded with the vision of delivering unbiased and accurate reporting, we are dedicated to providing you the very best of news, with an emphasis on speed, reliability, and factual journalism.</p>
                ...
                <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Why Choose दैनिक सबसे तेज़?</h2>
                ...
                <p className="font-bold mt-4">Sincerely,<br />The दैनिक सबसे तेज़ Team</p>
            </div>
        </div>
    );
};
