...
export default function Authors() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <Helmet>
                <title>Authors | दैनिक सबसे तेज़ News</title>
                <meta name="description" content="Meet the editorial team and authors behind दैनिक सबसे तेज़ News." />
            </Helmet>
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="p-8 prose prose-lg max-w-none text-gray-700">
                    <p>At दैनिक सबसे तेज़ News, we pride ourselves on having a dedicated team of experienced journalists, reporters, and editors who work tirelessly to bring you accurate and timely news.</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        <div className="border border-gray-100 rounded-xl p-6 bg-gray-50">
                            ...
                            <p className="text-sm text-gray-500 mb-3">दैनिक सबसे तेज़ News</p>
