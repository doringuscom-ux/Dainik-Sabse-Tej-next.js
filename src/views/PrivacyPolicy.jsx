...
const PrivacyPolicy = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = 'Privacy Policy | दैनिक सबसे तेज़';
    }, []);
    ...
    return (
        <div className="w-full max-w-[1270px] mx-auto px-4 py-10">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
                <p>Welcome to दैनिक सबसे तेज़ ("we", "our", "us"). We respect your privacy and are committed to protecting it through our compliance with this policy. This policy describes the types of information we may collect from you or that you may provide when you visit the website dainiksabsetej.com and our practices for collecting, using, maintaining, protecting, and disclosing that information.</p>
                ...
                <p>To ask questions or comment about this privacy policy and our privacy practices, contact us at: <strong>dainiksabsetejlive@gmail.com</strong></p>
