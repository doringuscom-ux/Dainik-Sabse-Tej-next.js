...
const Disclaimer = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = 'Disclaimer | दैनिक सबसे तेज़';
    }, []);
    ...
    return (
        <div className="w-full max-w-[1270px] mx-auto px-4 py-10">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
                <p>The information provided by दैनिक सबसे तेज़ on dainiksabsetej.com is for general informational and journalistic purposes only. All information on the Site is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the absolute accuracy, adequacy, validity, reliability, availability or completeness of any information on the Site.</p>
                
                <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">1. Errors and Omissions (त्रुटियां और चूक)</h2>
                <p>We strive to provide highly accurate and up-to-date news. However, journalism involves human effort, and errors or omissions may occasionally occur. दैनिक सबसे तेज़ assumes no responsibility or liability for any errors or omissions in the content of this site. The information is provided on an "as is" basis.</p>
                ...
                <p>दैनिक सबसे तेज़ provides the facility to share generated e-paper cuttings. We hold no responsibility for how these images are altered, misused, or interpreted on third-party social media platforms once shared by users.</p>
            </div>
        </div>
    );
};
