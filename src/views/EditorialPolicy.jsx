...
const EditorialPolicy = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = 'Editorial Policy | दैनिक सबसे तेज़';
    }, []);
    ...
    return (
        <div className="w-full max-w-[1270px] mx-auto px-4 py-10 font-sans">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
                ...
                <p>दैनिक सबसे तेज़ मुख्य रूप से एक न्यूज़ एग्रीगेटर (News Aggregator) के रूप में भी काम करता है। हमारे एडिटर्स (Editors) और रिपोर्टर्स विभिन्न अन्य न्यूज़ वेबसाइट्स, समाचार एजेंसियों (Agencies), सोशल मीडिया और अन्य स्रोतों से खबरें लेकर उन्हें अपने शब्दों में एडिट (Edit) और रीराइट (Rewrite) करके पब्लिश करते हैं।</p>
                ...
                <p>दैनिक सबसे तेज़ के एडिटर्स अन्य स्रोतों (Other Sources) से खबरें लेकर उन्हें एडिट करके पब्लिश करते हैं। हम खबर प्रकाशित करने से पहले सामान्य सावधानी बरतते हैं, लेकिन <strong>मूल खबर (Original News) की 100% सत्यता की जिम्मेदारी मूल स्रोत (Original Source) की होती है।</strong></p>
                <p>यदि हमारे द्वारा एडिट करके पब्लिश की गई किसी खबर में मूल स्रोत की वजह से कोई गलती, भ्रामक जानकारी या विवाद होता है, तो दैनिक सबसे तेज़ इसके लिए कानूनी रूप से उत्तरदायी नहीं होगा। अगर हमें किसी खबर में गलती का पता चलता है, तो हम उसे तुरंत एडिट या डिलीट कर देंगे।</p>
            </div>
        </div>
    );
};
