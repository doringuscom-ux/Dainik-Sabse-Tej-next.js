...
const FactCheckPolicy = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = 'Fact Check Policy | दैनिक सबसे तेज़';
    }, []);
    ...
    return (
        <div className="w-full max-w-[1270px] mx-auto px-4 py-10 font-sans">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
                ...
                <p>पत्रकारिता एक गतिशील क्षेत्र है। यदि दैनिक सबसे तेज़ पर प्रकाशित किसी खबर में मानवीय त्रुटि, गलत नाम, स्थान, या भ्रामक जानकारी पाई जाती है, तो हम तुरंत कार्रवाई करते हैं:</p>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <p>यदि किसी व्यक्ति, संस्था या पाठक को लगता है कि दैनिक सबसे तेज़ पर प्रकाशित कोई खबर गलत या अधूरी है, तो वे सीधे हमें Correction Request भेज सकते हैं। कृपया अपनी शिकायत के साथ खबर का लिंक और सही जानकारी/सबूत अटैच करें।</p>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 my-4">
                    ...
                    <p><strong>Email:</strong> dainiksabsetejlive@gmail.com</p>
                    <p><strong>Address:</strong> दैनिक सबसे तेज़ Network, SCO 19, Sector 11, Panchkula, Haryana 134109</p>
                </div>

                <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">5. Limitation of Liability / जवाबदेही की सीमा</h2>
                <p><strong>Strict Disclaimer:</strong> दैनिक सबसे तेज़ news publish karne se pehle fact-check aur verification karne ki koshish karega. Agar koi news galat, adhuri ya misleading nikli, to use edit, update, correct ya delete kiya jayega. दैनिक सबसे तेज़ jaanbujhkar fake news publish nahi karega. Agar kisi source ki wajah se anjane me galat news publish ho jaye, to दैनिक सबसे तेज़ good faith me correction karega aur kanoon ke andar jitni protection mil sakti hai, utni claim karega.</p>
                <p className="mt-4 text-gray-600 italic">दैनिक सबसे तेज़ makes every effort to fact-check and verify news before publication. If any news is found to be incorrect, incomplete, or misleading, it will be edited, updated, corrected, or deleted. दैनिक सबसे तेज़ does not intentionally publish fake news. If incorrect news is inadvertently published due to a source, दैनिक सबसे तेज़ will make corrections in good faith and claim the maximum protection available under the law.</p>
            </div>
        </div>
    );
};
