...
export default function CorrectionsPolicy() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <Helmet>
                <title>Corrections Policy | दैनिक सबसे तेज़ News</title>
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="p-8 prose prose-lg max-w-none text-gray-700">
                    <p>At दैनिक सबसे तेज़ News, we are committed to telling our readers when an error has been made, the magnitude of the error, and the correct information, as quickly as possible. This commitment and transparency apply to small errors as well as large ones.</p>
