...
export default function Epaper({ initialNews, initialSuvichar, initialPanchang }) {
    ...
    const generateClassicCutting = async (item, catHindi, bannerColor = '#0284c7', isFullArticle = false) => {
        try {
            ...
            footer.innerHTML = `<span>दैनिक सबसे तेज़ • सच्ची खबर, बेबाक नजर</span> <span>www.dainiksabsetej.com</span>`;
            ...
            link.download = `दैनिक सबसे तेज़_Classic_Cutting_${cleanTitle}.jpg`;
            link.click();
        } catch (error) {
    ...
    const downloadNewsCutting = async (id, title, item, theme = 'default', catHindi = '', bannerColor = '#0284c7') => {
        ...
        try {
            ...
            link.download = `दैनिक सबसे तेज़_News_Cutting_${cleanTitle}.jpg`;
            link.click();
        } catch (error) {
            ...
            >
                ...
                <div id="epaper-masthead" className="border-b-[6px] border-black/20 pb-4 pt-6 px-6 relative">
                    ...
                    <div className="flex justify-between md:grid md:grid-cols-3 gap-1 md:gap-2 text-[12px] md:text-[14px] font-semibold border-y-[3px] border-[#801515] py-2.5 mt-4 bg-gradient-to-r from-[#801515] via-[#a61c1c] to-[#801515] text-white px-6 md:px-10 items-center shadow-sm -mx-6">
                        <a href="https://dainiksabsetej.com/" target="_blank" rel="noreferrer" className="text-left font-sans font-bold uppercase tracking-[0.02em] sm:tracking-[0.15em] text-[10px] md:text-[13px] whitespace-nowrap flex items-center gap-1.5 opacity-95 hover:text-gray-200 transition-colors">
                            <FaGlobe className="text-[12px] md:text-[15px] opacity-90 shrink-0" /> <span className="hidden sm:inline">WWW.DAINIKSABSETEJ.COM</span><span className="sm:hidden">DAINIKSABSETEJ.COM</span>
                        </a>
                        ...
                        <div className="flex items-center justify-end gap-2 md:gap-4 text-[13px] sm:text-[15px] md:text-[18px]">
                            ...
                            <a href="https://www.instagram.com/dainiksabsetej/" target="_blank" rel="noreferrer" className="text-white hover:text-[#ffb3c6] hover:-translate-y-0.5 transition-all drop-shadow-md"><FaInstagram /></a>
                            <a href="https://www.facebook.com/dainiksabsetej" target="_blank" rel="noreferrer" className="text-white hover:text-[#b3d4ff] hover:-translate-y-0.5 transition-all drop-shadow-md"><FaFacebook /></a>
                            <a href="https://www.tumblr.com/dainiksabsetej" target="_blank" rel="noreferrer" className="hidden sm:block text-white hover:text-[#b3c6ff] hover:-translate-y-0.5 transition-all drop-shadow-md"><FaTumblr /></a>
                            <a href="https://x.com/dainiksabsetej" target="_blank" rel="noreferrer" className="hidden sm:block text-white hover:text-gray-300 hover:-translate-y-0.5 transition-all drop-shadow-md"><FaXTwitter /></a>
                            <a href="https://in.pinterest.com/dainiksabsetej/" target="_blank" rel="noreferrer" className="hidden sm:block text-white hover:text-[#ffb3c6] hover:-translate-y-0.5 transition-all drop-shadow-md"><FaPinterest /></a>
                                            ...
                                            <div className="mb-3 overflow-hidden border border-black/10 bg-white shadow-sm">
                                                ...
                                                {style === 'headline' && (
                                                    <p className="text-[9px] font-mono bg-gray-100 p-1 text-center border-t border-black/10">
                                                        📸 सांकेतिक तस्वीर | फोटो: दैनिक सबसे तेज़
                                                    </p>
                                                )}
                                            </div>
                                        )}
                ...
                <div id="epaper-footer" className="border-t border-black/20 pt-4 pb-6 flex flex-col items-center gap-5 bg-transparent">
                    <div className="text-xs font-sans font-medium text-center text-gray-700 tracking-wide px-4">
                        प्रकाशक: दैनिक सबसे तेज़ मीडिया | यह ई-पेपर मूल मुद्रित संस्करण के समान प्रमाणिक है।
                    </div>
                    ...
                    <div className="w-full flex items-center justify-between px-2 sm:px-6 md:px-10">
                        ...
                        <div className="flex gap-1.5 md:gap-2 items-center">
                            ...
                            <a href="https://www.facebook.com/dainiksabsetej" target="_blank" rel="noreferrer" className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#1877F2] flex items-center justify-center text-white shadow-sm hover:scale-110 transition-transform"><FaFacebookF className="text-xs md:text-base" /></a>
                            <a href="https://x.com/dainiksabsetej" target="_blank" rel="noreferrer" className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-black flex items-center justify-center text-white shadow-sm hover:scale-110 transition-transform"><FaXTwitter className="text-xs md:text-base" /></a>
                        </div>
                    </div>
                </div>
