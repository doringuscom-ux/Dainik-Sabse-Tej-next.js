...
const ContactUs = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        document.title = 'Contact Us | दैनिक सबसे तेज़';
    }, []);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8">
                <div>
                    ...
                    <p className="text-gray-700 mb-8 leading-relaxed">
                        We value your feedback, news tips, and inquiries. Please feel free to reach out to the दैनिक सबसे तेज़ team using the contact information below.
                    </p>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 mt-1">dainiksabsetejlive@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 mt-1">दैनिक सबसे तेज़ Network<br/>SCO 19, Sector 11<br/>Panchkula, Haryana 134109</p>
                            </div>
                        </div>
                    </div>
                </div>
