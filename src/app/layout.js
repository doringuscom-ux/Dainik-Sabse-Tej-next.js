...
export async function generateMetadata() {
  ...
  try {
    ...
    if (seo) {
      return {
        ...
        title: {
          template: `%s | ${seo.siteTitle || 'दैनिक सबसे तेज़ News'}`,
          default: seo.siteTitle || 'दैनिक सबसे तेज़ News',
        },
  ...
  return {
    ...
    title: {
      template: `%s | दैनिक सबसे तेज़ News`,
