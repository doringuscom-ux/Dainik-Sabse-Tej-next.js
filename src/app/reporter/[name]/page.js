...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${displayName} - Chief Editor & Articles | दैनिक सबसे तेज़`,
    description: `Read exclusive news reports, ground coverage, and latest articles written by ${displayName} on दैनिक सबसे तेज़.`,
    robots: 'index, follow',
    alternates: {
      canonical: `/reporter/${rawName}`,
    },
    openGraph: {
      title: `${displayName} - Reporter Profile | दैनिक सबसे तेज़`,
      description: `Articles and news reports by ${displayName} on दैनिक सबसे तेज़.`,
      type: 'profile',
    },
  };
}
